  ...
  return (
    <div>
      ...
      <div className="container-coluna">
        ...
        <video src={ VR1 } type="video/mp4" controls autoplay="autoplay" width="80%"></video>
        ...
        <p/>
        <h2 className="casa-maquinas">
          Casa de Máquinas
        </h2>
        <p/>

        <h4 className="text-maquinas">
        ...
        <video src={ VR5 } className="ultimo-video" type="video/mp4" controls width="80%"></video>
